...
def generate_launch_description():
    ...
    # Include rosbag play launch from sensors package
    ias_launch_file = os.path.join(
        get_package_share_directory(sensors_package), "launch", "sensors_rviz.launch.py"
    )

    include_rosbag_play = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(ias_launch_file),
        launch_arguments={"which_bag": bag}.items(),
    )
